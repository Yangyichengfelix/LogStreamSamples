namespace Mac2sAPI.Dtos.Log
{
    public class LogCreateDto
    {
        ...
        public int Abs_Val_S1_microm { get; set; }

        public int Abs_Val_S2_microm { get; set; }

        public int Abs_Val_S3_microm { get; set; }

        public int Abs_Val_S4_microm { get; set; }

        public int Abs_Val_S5_microm { get; set; }
